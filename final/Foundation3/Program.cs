...
class Program {
    static void Main(string[] args) {
        Address address1 = new Address("123 Main St", "Dubai", "CA", "12345");
        Address address2 = new Address("456 Elm St", "Sharjah", "NY", "67890");
        Address address3 = new Address("789 Maple St", "Abuja", "FL", "54321");
        ...
        Reception reception = new Reception("Networking Reception", "A networking reception for professionals", new DateTime(2023, 6, 1), new TimeSpan(18, 0, 0), address3, "Princeuche08@gmail.com");
